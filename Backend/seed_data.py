...
def seed():
    ...
    try:
        ...
        # 4. Create Products
        products = [
            Product(name="Fresh Lady Finger", description="Farm fresh organic red tomatoes", price=45.0, quantity=100, category_id=veg.id, farmer_id=farmer_record.id, image_url="https://5.imimg.com/data5/SELLER/Default/2024/12/469587246/PY/VA/BH/30026118/okra-bhendi-0-25-814.webp"),
            ...
            Product(name="Fresh Broccoli", description="Farm fresh organic green broccoli", price=120.0, quantity=50, category_id=veg.id, farmer_id=farmer_record.id, image_url="https://cdn.pixabay.com/photo/2016/03/05/19/02/broccoli-1238250_640.jpg"),
